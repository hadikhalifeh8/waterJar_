...
import 'package:water_jar/controller/Towns/editController.dart';
...
class EditTown  extends StatelessWidget {
  const EditTown ({super.key});

  @override
  Widget build(BuildContext context) {
     Get.lazyPut(() =>EditTownController());
    ...
    body:
          GetBuilder<EditTownController>(builder: (controller)
          =>
    ...
    CustomTextFormTown(
     ...
     CustomButton(
                  onPressed_: (){
                    controller.updateData(controller.townsModel!.id.toString());
                    }, 
                  text_: "Submit",
                  ),
