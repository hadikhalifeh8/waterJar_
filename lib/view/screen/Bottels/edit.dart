...
import 'package:water_jar/controller/Bottels/editController.dart';
...
class EditBottels extends StatelessWidget {
  const EditBottels({super.key});

  @override
  Widget build(BuildContext context) {
     Get.lazyPut(() =>EditBottelController());
    ...
    body:
          GetBuilder<EditBottelController>(builder: (controller) => 
     ...
     CustomButton(
                  onPressed_: (){
                     controller.updateData(controller.bottelsModel!.id.toString());
                    }, 
                  text_: "Submit",
                  ),
